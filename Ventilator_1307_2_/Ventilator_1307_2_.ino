...
const float MIN_PRESSURE = 1.0, MAX_PRESSURE = 20.0; //variabel batas atas dan bawah tekanan. //cmH2O
const int pResist_Max = 10; //cmH2O
//===============================

//==========Timer================
float tHold = 0.1;  //Waktu penahanan nafas //s
int timer_pressure_limit = 5000;  //Batas waktu apabila tekanan dibawah nilai yg ditetapkan //ms
