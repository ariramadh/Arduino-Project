...
void fuzzySetup(){
  ...
  FuzzySet *Tkecil = new FuzzySet(0, 0, 2, 3); //Inisialisasi objek fuzzy
  selisihSuhu->addFuzzySet(Tkecil);  //Masukan objek fuzzy ke input selisihSuhu

  FuzzySet *Tsedang = new FuzzySet(1, 3, 3, 4);  //Inisialisasi objek fuzzy
  selisihSuhu->addFuzzySet(Tsedang); //Masukan objek fuzzy ke input selisihSuhu

  FuzzySet *Tbesar = new FuzzySet(3, 10, 50, 50);  //Inisialisasi objek fuzzy
