...
const float tHold = 0.1;  //Waktu penahanan nafas
...
void perintah(int durasi, int cycle) {
  ...
  const int timer_pressure_limit = 5000;  //Batas waktu apabila tekanan dibawah nilai yg ditetapkan
  ...
  switch (cycle) {  //Jalankan perintah sesuai siklus
    case 0:
      ...
      while (encd <=  posisi && inOk) { //Jalankan perintah sesuai durasi
        //        Serial.print("\tINHALE\t");
        //        readSerial();
        //        Serial.print("\tIn Time\t"); Serial.print(tIn);
        //        Serial.print("\tIn Time\t"); Serial.print(pwm);
        ...
        Serial.print("\tEncd\t"); Serial.print(encd);    //Waktu Inhale
...
//      Serial.print(" COUNT "); Serial.println(encd);
//      Serial.print(" PRESSURE "); Serial.println(pressure);
//      Serial.print(" FLOW "); Serial.println(Q1);
      inState = false;
...
//    Serial.println("/E/#");
      ...
      int countEx = abs(exPos - (encd - exPos)) ;
...
//          analogWrite(Min1, constrain(pwm * 2, 0, 255)); //Jalankan motor
        ...
        Serial.print("\tEXHALE Selesai ");
        delay(50);
        Serial.print("/R/#");Serial.print("/R/#");Serial.print("/R/#");
