...
switch(jalur){
  case jalur1 :
    ...
    sen4 = digitalRead(16);sen5 = digitalRead(15);
     ...
     if(sen1 == LOW && sen2 == HIGH && sen3 == LOW  && sen4 == LOW && sen5 == LOW ){analogWrite(pwm1, 45); analogWrite(pwm2, 0);}//belok kiri
     if(sen1 == LOW && sen2 == LOW && sen3 == LOW && sen4 == HIGH && sen5 == LOW ){analogWrite(pwm1, 0); analogWrite(pwm2, 45);}//belok kanan
     if(sen1 == LOW && sen2 == LOW && sen3 == LOW && sen4 == LOW && sen5 == HIGH ){analogWrite(pwm1, 0); analogWrite(pwm2, 60);}//belok kanan
     if(sen1 == LOW && sen2 == LOW && sen3 == LOW && sen4 == HIGH && sen5 == HIGH){analogWrite(pwm1,0); analogWrite(pwm2, 60);}//belok kanan penuh
